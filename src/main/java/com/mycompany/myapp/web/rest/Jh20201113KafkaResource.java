...
@RestController
@RequestMapping("/api/jh-20201113-kafka")
public class Jh20201113KafkaResource {
    private final Logger log = LoggerFactory.getLogger(Jh20201113KafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public Jh20201113KafkaResource(KafkaProperties kafkaProperties) {
