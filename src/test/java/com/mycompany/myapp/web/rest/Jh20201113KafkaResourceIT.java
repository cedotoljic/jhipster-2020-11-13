...
class Jh20201113KafkaResourceIT {
    ...
    void setup() {
        ...
        Jh20201113KafkaResource kafkaResource = new Jh20201113KafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jh-20201113-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jh-20201113-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
